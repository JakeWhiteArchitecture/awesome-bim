...
- [BlenderBIM](https://blenderbim.org/) - BlenderBIM is an add-on for beautiful, detailed, and data-rich OpenBIM with Blender. Developed based on Ifcopenshell. 
...
- [XbimWindowsUI](https://github.com/xBimTeam/XbimWindowsUI) - XbimWindowsUI is part of the Xbim Toolkit. It contains libraries and applications that you can use to build applications on Windows desktops.

- [XbimWebUI](https://github.com/xBimTeam/XbimWebUI) - Web components for xBIM Toolkit.
...
- [ifcSQL-Database](https://github.com/IfcSharp/IfcSQL) -  ifcSQL is a database-schema for storing IFC-based models including the IFC data model schema of buildingSMART International.
...
- [dotbim](https://github.com/paireks/dotbim) - Introducing an open-source and minimalist file format for BIM. Built to be easy to read and write.Created by BIM developers for BIM developers. [![GitHub stars](https://img.shields.io/github/stars/paireks/dotbim)](https://github.com/paireks/dotbim/stargazers)[![GitHub forks](https://img.shields.io/github/forks/paireks/dotbim)](https://github.com/paireks/dotbim/network)![GitHub contributors](https://img.shields.io/github/contributors/paireks/dotbim)![GitHub last commit](https://img.shields.io/github/last-commit/paireks/dotbim)[![GitHub license](https://img.shields.io/github/license/paireks/dotbim)](https://github.com/paireks/dotbim/blob/master/LICENSE)

### Python

- [SikongSphere Sikong](https://github.com/SikongSphere/sikong) - This project has open sourced the LLaMA-7B model that has been fine-tuned/instruct-tuned in Chinese architecture.[![GitHub stars](https://img.shields.io/github/stars/SikongSphere/sikong)](https://github.com/IfcOpenShell/IfcOpenShell/stargazers)[![GitHub forks](https://img.shields.io/github/forks/SikongSphere/sikong)](https://github.com/IfcOpenShell/IfcOpenShell/network)![GitHub contributors](https://img.shields.io/github/contributors/SikongSphere/sikong)![GitHub last commit](https://img.shields.io/github/last-commit/SikongSphere/sikong)[![GitHub license](https://img.shields.io/github/license/SikongSphere/sikong)](https://github.com/SikongSphere/sikong/blob/master/LICENSE)

- [IfcOpenShell-Python](https://blenderbim.org/docs-python/ifcopenshell-python.html) - IfcOpenShell-Python provides Python bindings to the core IfcOpenShell C++ system, as well as high level analysis and authoring functions.[![GitHub stars](https://img.shields.io/github/stars/IfcOpenShell/IfcOpenShell)](https://github.com/IfcOpenShell/IfcOpenShell/stargazers)[![GitHub forks](https://img.shields.io/github/forks/IfcOpenShell/IfcOpenShell)](https://github.com/IfcOpenShell/IfcOpenShell/network)![GitHub contributors](https://img.shields.io/github/contributors/IfcOpenShell/IfcOpenShell)![GitHub last commit](https://img.shields.io/github/last-commit/IfcOpenShell/IfcOpenShell)[![GitHub license](https://img.shields.io/github/license/IfcOpenShell/IfcOpenShell)](https://github.com/IfcOpenShell/IfcOpenShell/blob/master/LICENSE)
...
- Github
  - [buildingSMART/Sample-Test-Files](https://github.com/buildingSMART/Sample-Test-Files) Sample files of various formats and schema versions for testing implementations.A collection of test cases provided by Buildsmart. [![GitHub stars](https://img.shields.io/github/stars/buildingSMART/Sample-Test-Files)](https://github.com/buildingSMART/Sample-Test-Files/stargazers)[![GitHub forks](https://img.shields.io/github/forks/buildingSMART/Sample-Test-Files)](https://github.com/zhaoke2020/Arch-Dataset/network)![GitHub contributors](https://img.shields.io/github/contributors/buildingSMART/Sample-Test-Files)![GitHub last commit](https://img.shields.io/github/last-commit/buildingSMART/Sample-Test-Files)[![GitHub license](https://img.shields.io/github/license/buildingSMART/Sample-Test-Files)](https://github.com/buildingSMART/Sample-Test-Files/blob/master/LICENSE)
